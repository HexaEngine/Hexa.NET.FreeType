...
batch.Start()
    ...
    .AlterConfig(c =>
    {
        ...
        c.EnumMappings.Add(enumMappingFTGlyphFormat);
        ...
        c.EnumMappings.Add(enumMappingFTEncoding);
    })
    .AddPrePatch(new NamingPatch(["FT"], NamingPatchOptions.None))
    .Generate("include/main.h", "../../../../Hexa.NET.FreeType/Generated", [.. Directory.GetFiles("include", "", SearchOption.AllDirectories)])
    .Finish();